...
import com.axelor.apps.repo.SaleOrderLineConstructionRepository;
...
import com.axelor.apps.service.ConstructionMultiLevelSaleOrderLineServiceImpl;
...
public class ConstructionModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(MultiLevelSaleOrderLineServiceImpl.class)
        .to(ConstructionMultiLevelSaleOrderLineServiceImpl.class);
    bind(SaleOrderLineSupplychainRepository.class).to(SaleOrderLineConstructionRepository.class);
  }
}
